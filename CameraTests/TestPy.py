...
greyThresh = cv2.cvtColor(thresh, cv2.COLOR_RGB2GRAY)
...
canny = cv2.Canny(greyThresh, 100,200)
minLineLength = 70
maxLineGap = 60
...
cv2.imwrite('grayThresh.jpg', greyThresh)
...
cont, contours, hierarchy = cv2.findContours(combined, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
